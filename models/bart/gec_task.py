...
from augmenters.mixedit import MixEditAugmenter
...
class GECTask(TranslationTask):
    def __init__(self, cfg: GECConfig, src_dict, tgt_dict):
    ...
    def build_model(self, cfg: GECConfig, from_checkpoint=False):
        ...
        if cfg.augmentation_enable_mixedit:
            ...
            self.augmenter.setup(data=dataset, build_tgt2sample=True)
        return model
    ...
    @staticmethod
    def _sample_span_length(span_len_dist, max_span_len, geometric_prob=0.2, poisson_lambda=5.0):
    ...
    @staticmethod
    def _get_default_spans(batch_index, seq_length, num_spans):
